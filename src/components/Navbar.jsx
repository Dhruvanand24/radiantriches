...
const Navbar = () => {
  ...
  <div className="navbar-center lg:hidden"> <ul className="menu menu-horizontal px-1 text-[#D1D6DA] items-center gap-16 font-inter">
      <li><div className='bg-[#FFFFFF] ring-[1px] ring-[#E1E4E6] hover:bg-white p-0 px-4'><img src="/search.svg" alt="" /><input className='h-[40px] bg-[#FFFFFF] focus:outline-none focus:border-none input-sm lg:input' placeholder='search..'></input></div></li>
